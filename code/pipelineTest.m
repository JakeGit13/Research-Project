...
%% Test reconstruction (simple version first)
% For now, just verify we can go from spectrogram back to audio
% This is a simplified test - proper reconstruction comes later